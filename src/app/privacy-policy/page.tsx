...
export const metadata: Metadata = {
  ...
  description:
    "This Privacy Policy outlines how we collect, use, and protect your personal data when you visit our website. It details your rights regarding your data, including access, correction, and deletion, as well as information on data processing, storage duration, and the responsible party for data handling.",
};
      ...
      <Section className="mt-[56] px-5">
        <div className="flex flex-col gap-[26px]">
          ...
          <h3
            className={cn(
              frutigerBold.className,
              "text-white text-[20px] leading-[25px]"
            )}
          >
          ...
          >
            ...
            <p>
              ...
              Pascalstraße 10, 10587 Berlin (nachfolgend: „Strato“). Wenn Sie
              unsere Website besuchen, erfasst Strato verschiedene Logfiles
              inklusive Ihrer IP-Adressen. Weitere Informationen entnehmen Sie
              der Datenschutzerklärung von Strato:
              https://www.strato.de/datenschutz/. Die Verwendung von Strato
